...
\begin{frame}
    ...
    \begin{block}{Quarterly-rebalanced Sorted Portfolio}
        \begin{itemize}
            ...
            \item Transaction costs: 20 basis points for long-only portfolio and 40 basis points for long-short portfolios when rebalancing. (a rough but relatively conservative estimate based on \textcolor{blue}{Frazzini, Israel, and Moskowitz (2015)})
        \end{itemize}
    \end{block}
\end{frame}
